    ...
    public sealed class MockDataStore : IDataStore
    {
        ...
        private MockDataStore()
        {
            ...
            foreach (var data in mockItems)
            {
                ...
                var mockCharacters = new List<Character>
                 {
                new Character { characterClass = "First Character"},// Description="This is an Character description.", Level = 1 },
                new Character { characterClass = "Second Character"},//, Description="This is an Character description." , Level = 1},
                new Character {  characterClass = "Third Character"},//, Description="This is an Character description." , Level = 2},
                new Character {  characterClass = "Fourth Character"},//, Description="This is an Character description." , Level = 2},
                new Character { characterClass = "Fifth Character"},/// Description="This is an Character description." , Level = 3},
                new Character {  characterClass = "Sixth Character"},// Description="This is an Character description." , Level = 3},
                 };
            ...
            var mockMonsters = new List<Monster>
                 {
                new Monster {  dropPool = new Item[1]},//"First Monster", Description="This is an Monster description." },
                new Monster { dropPool = new Item[1]},// Name = "Second Monster", Description="This is an Monster description." },
                new Monster { dropPool = new Item[1]},// Name = "Third Monster", Description="This is an Monster description." },
                new Monster { dropPool = new Item[1]},// Name = "Fourth Monster", Description="This is an Monster description." },
                new Monster { dropPool = new Item[1]},//Name = "Fifth Monster", Description="This is an Monster description." },
                new Monster { dropPool = new Item[1]}// Name = "Sixth Monster", Description="This is an Monster description." },
                 };
